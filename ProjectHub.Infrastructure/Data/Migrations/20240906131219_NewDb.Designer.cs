...
namespace ProjectHub.Infrastructure.Data.Migrations
{
    ...
    [Migration("20240906131219_NewDb")]
    partial class NewDb
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "6f2f4403-fe67-42e2-beed-2fd32ff5eaaa",
                            Name = "User",
                            NormalizedName = "USER"
                        },
                        new
            ...
            modelBuilder.Entity("ProjectHub.Domain.Shared.Entities.Tag", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("ProjectHub.Domain.User.Entities.ApiUser", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Information", "ProjectHub.Domain.User.Entities.ApiUser.Information#PersonalInfo", b1 =>
                        {
                            b1.IsRequired();
            ...
            modelBuilder.Entity("ProjectHub.Domain.Workspace.RelationShips.EpicTag", b =>
                {
                    ...
                    b.HasOne("ProjectHub.Domain.Shared.Entities.Tag", "Tag")
                        .WithMany("EpicTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
